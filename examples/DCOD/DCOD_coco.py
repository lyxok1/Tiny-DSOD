...
model_name = "DCOD300_COCO_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/DCOD300/COCO/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/DCOD300/COCO/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/DCOD300/COCO/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/COCOdevkit/results/{}".format(os.environ['HOME'], job_name)
...
DCOD300_Body(net, from_layer='data',growth_rate=32, use_reverse=reverse_connect)
from_layers = mbox_source_layers

mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=from_layers,
        use_batchnorm=use_batchnorm, min_sizes=min_sizes, max_sizes=max_sizes, use_objectness=False,
