...
AnnotatedDataLayer<Dtype>::AnnotatedDataLayer(const LayerParameter& param)
  : BasePrefetchingDataLayer<Dtype>(param),
    ...
    // voc2mic_.insert(make_pair(1, 6));
    // voc2mic_.insert(make_pair(3, 7));
    // voc2mic_.insert(make_pair(4, 14));
    // voc2mic_.insert(make_pair(5, 15));
    // voc2mic_.insert(make_pair(5, 6));
    // voc2mic_.insert(make_pair(6, 5));
}
      ...
      if (has_anno_type_) {
        ...
        if (anno_type_ == AnnotatedDatum_AnnotationType_BBOX) {
          ...
          for (int g = 0; g < transformed_anno_vec.size(); ++g) {
            // if(voc2mic_.find(transformed_anno_vec[g].group_label())==voc2mic_.end())
            //   continue;
      ...
      if (num_bboxes == 0) {
        ...
        for (int item_id = 0; item_id < batch_size; ++item_id) {
          ...
          for (int g = 0; g < anno_vec.size(); ++g) {
            ...
            // LOG(INFO) << "idx: " << g << " label: " << anno_group.group_label();
